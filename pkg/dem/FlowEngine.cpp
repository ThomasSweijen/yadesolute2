...
template<class Solver>
void FlowEngine::solute_BC(unsigned int bcid1, unsigned int bcid2, double bcconcentration1, double bcconcentration2, unsigned int s, Solver& flow)
{
...
template<class Solver>
double FlowEngine::getConcentrationPlane (double Yobs,double Yr, int xyz, Solver& flow )
{
